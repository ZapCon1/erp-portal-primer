...
| Online payments **[module]** | 👤 | Card/ACH via a payments provider; **webhook** marks invoices paid. The handler re-fetches the amount from the provider rather than trusting the payload (`secure_coding.md` § 16). Boundary: `docs/MODULES.md` § Payments. |
